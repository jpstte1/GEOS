...
#######################################
# Newer cmake requirement
#######################################
set ( DOWNLOAD_EXTRACT_TIMESTAMP ON CACHE BOOL "" )

#
# ATS Python TESTING
#
set(USER $ENV{USER} CACHE STRING "")
set(ATS_ARGUMENTS "--machine pine"  CACHE STRING "")
set(ATS_WORKING_DIR "/shared/scratch1/${USER}/integratedTestsGEOS/${CONFIG_NAME}"  CACHE PATH "")
set(ATS_BASELINE_DIR "/shared/scratch1/${USER}/integratedTestsGEOS/baseline"  CACHE PATH "")
